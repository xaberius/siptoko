...
SQL = "insert into UserX values('" & Trim(TxtID) & "','" & Trim(TxtNama) & "','" & Trim(pass) & _
    "','" & FormatTgl(Date) & "','Admin','" & FormatTgl(Date + 30) & "')"
DbCon.Execute SQL
MsgBox "Data Saved"
Form_Load
End Sub
...
SQL = "Select UserID as[User ID],UserName as [User Name],TglEntry as [Tanggal Pembuatan], " & _
    " TglExp as [Tanggal Expired] from UserX order by userId"
